...
def main():
    ...
    # FIX (ponto 3): action='store_true' + default=True nunca permitia desativar o
    # filtro via CLI (a flag só conseguia manter True, presente ou ausente).
    # BooleanOptionalAction gera automaticamente o par --filter_unknown / --no-filter_unknown.
    parser.add_argument('--filter_unknown', action=argparse.BooleanOptionalAction, default=True,
                        help='Filter out unknown sleep stage (code 5). Use --no-filter_unknown para manter.')
